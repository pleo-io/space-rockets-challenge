...
function TimeAndLocation({ launch }) {
  return (
    <SimpleGrid columns={[1, 1, 2]} borderWidth="1px" p="4" borderRadius="md">
      ...
      <Stat>
        <StatLabel display="flex">
          <Box as={MapPin} width="1em" /> <Box ml="2">Launch Site</Box>
        </StatLabel>
        <StatNumber fontSize={["md", "xl"]}>
          <Link
            as={RouterLink}
...
function RocketInfo({ launch }) {
  ...
  return (
    ...
    >
      <Stat>
        <StatLabel display="flex">
          <Box as={Navigation} width="1em" /> <Box ml="2">Rocket</Box>
        </StatLabel>
        <StatNumber fontSize={["md", "xl"]}>
      ...
      <StatGroup>
        <Stat>
          <StatLabel display="flex">
            <Box as={Layers} width="1em" /> <Box ml="2">First Stage</Box>
          </StatLabel>
          <StatNumber fontSize={["md", "xl"]}>
        ...
        <Stat>
          <StatLabel display="flex">
            <Box as={Layers} width="1em" /> <Box ml="2">Second Stage</Box>
          </StatLabel>
          <StatNumber fontSize={["md", "xl"]}>
