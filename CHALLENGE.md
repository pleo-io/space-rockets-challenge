...
When you're ready to work on the challenge, clone the repo and implement each
task as a separate pull request against your version of the repo. Prepare the
